...
#define Oled_Clear_SCL()  SW_SCL_GPIO_Port->BSRR = (SW_SCL_Pin << 16); i2c_Delay_L()								// Fall time can be much faster
#endif

#define Oled_Clock()      Oled_Set_SCL(); Oled_Clear_SCL()

#define Oled_Set_SDA() 		SW_SDA_GPIO_Port->BSRR = SW_SDA_Pin
#define Oled_Clear_SDA() 	SW_SDA_GPIO_Port->BSRR = (SW_SDA_Pin << 16)
