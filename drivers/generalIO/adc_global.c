...
void ADC_Init(ADC_HandleTypeDef *adc){
  ...
  sConfig.SamplingTime = ADC_SAMPLETIME_28CYCLES;                                         // More sampling time to compensate high input impedances
    ...
    sConfig.SamplingTime = ADC_SAMPLETIME_480CYCLES;                                      // Last channel is internal temperature, requires min. 10uS sampling time
    #endif
